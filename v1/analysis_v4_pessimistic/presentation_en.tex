...
\begin{columns}
\column{0.5\textwidth}
\begin{block}{\faMapMarkedAlt\ New York Map}
\begin{itemize}
...
\column{0.5\textwidth}
\begin{block}{\faMapMarkedAlt\ Los Angeles Map}
\begin{itemize}
...
\begin{tikzpicture}
    ...
    \node at (5,0.6) {\small \faMousePointer\ \textbf{Hover over ZIP codes to see:} Blue route to helipad | Red route to airport};
\end{tikzpicture}
\end{center}
\end{frame}
