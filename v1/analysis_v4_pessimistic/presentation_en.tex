...
\begin{frame}{How We Calculate Traffic Multipliers}
\begin{center}
\includegraphics[width=0.92\textwidth,height=0.78\textheight,keepaspectratio]{../diagrams/multiplier_methodology_en.png}
\end{center}
\end{frame}

\begin{frame}{Google Traffic API: Data Flow}
\begin{center}
\includegraphics[width=0.92\textwidth,height=0.78\textheight,keepaspectratio]{../diagrams/google_api_flow_en.png}
\end{center}
\end{frame}

\begin{frame}{Multiplier Calculation: Numerical Examples}
\begin{columns}
\column{0.5\textwidth}
\begin{block}{\textcolor{revoBlue}{New York Example}}
\small
\textbf{Route:} Manhattan $\rightarrow$ JFK\\[0.3em]
\begin{tabular}{ll}
Baseline: & 47 min \\
Pessimistic: & 245 min \\
\textbf{Multiplier:} & $\frac{245}{47} = $ \textcolor{revoRed}{\textbf{5.21x}}
\end{tabular}
\end{block}

\begin{exampleblock}{NY City Average}
\begin{center}
52 routes analyzed\\
\textbf{Final: 5.20x}
\end{center}
...
\column{0.5\textwidth}
\begin{block}{\textcolor{revoOrange}{Los Angeles Example}}
\small
\textbf{Route:} Beverly Hills $\rightarrow$ LAX\\[0.3em]
\begin{tabular}{ll}
Baseline: & 36 min \\
Pessimistic: & 149 min \\
\textbf{Multiplier:} & $\frac{149}{36} = $ \textcolor{revoRed}{\textbf{4.14x}}
\end{tabular}
\end{block}

\begin{exampleblock}{LA City Average}
\begin{center}
44 routes analyzed\\
\textbf{Final: 4.15x}
\end{center}
...
\vspace{0.5em}
\begin{center}
\footnotesize{\textit{Data source: Google Distance Matrix API with traffic\_model=pessimistic}}
\end{center}
\end{frame}

\begin{frame}{Why Pessimistic Data?}
\begin{columns}
\column{0.5\textwidth}
\begin{block}{Google Traffic Models}
\begin{itemize}
    \item \textbf{best\_guess}: Average conditions
    \item \textbf{optimistic}: Lighter traffic
    \item \textcolor{revoRed}{\textbf{pessimistic}}: Worst historical
\end{itemize}
\end{block}

\begin{alertblock}{Our Choice: Pessimistic}
\begin{itemize}
    \item Represents real worst-case scenarios
    \item Based on actual historical data
    \item Critical for risk assessment
\end{itemize}
\end{alertblock}

\column{0.5\textwidth}
\begin{exampleblock}{What Causes Worst Traffic?}
\begin{itemize}
    \item \faExclamationTriangle\ Major accidents
    \item \faCloudRain\ Severe weather
    \item \faFootballBall\ Special events (sports, concerts)
    \item \faCalendarAlt\ Holiday periods
    \item \faRoad\ Road construction
\end{itemize}
\end{exampleblock}
\end{columns}
...
\begin{tikzpicture}
    ...
    \node at (5,0.4) {\small \textbf{Result:} NY 5.20x | LA 4.15x travel time in worst conditions};
\end{tikzpicture}
\end{center}
\end{frame}
...
\begin{frame}{Travel Time Variability by Scenario}
\begin{center}
\includegraphics[width=0.88\textwidth,height=0.78\textheight,keepaspectratio]{../variance_charts_en/fig1_std_by_scenario.png}
\end{center}
\end{frame}

\begin{frame}{Coefficient of Variation: Predictability}
\begin{center}
\includegraphics[width=0.88\textwidth,height=0.78\textheight,keepaspectratio]{../variance_charts_en/fig2_cv_comparison.png}
\end{center}
\end{frame}

\begin{frame}{Regional Variance: Key Findings}
\begin{columns}
\column{0.5\textwidth}
\begin{block}{Most Predictable (Low CV)}
\begin{itemize}
...
\column{0.5\textwidth}
\begin{alertblock}{Least Predictable (High CV)}
\begin{itemize}
...
\small{Low CV = More predictable travel times = Lower risk of delays\\
High CV = Higher uncertainty = Greater need for helicopter reliability}
\end{exampleblock}
\end{frame}

\begin{frame}{Distribution Analysis (Boxplots)}
\begin{center}
\includegraphics[width=0.85\textwidth,height=0.78\textheight,keepaspectratio]{../variance_charts_en/fig3_boxplots_variance.png}
\end{center}
\end{frame}

\begin{frame}{Travel Time vs Savings Correlation}
\begin{center}
\includegraphics[width=0.88\textwidth,height=0.78\textheight,keepaspectratio]{../variance_charts_en/fig5_scatter_mean_vs_savings.png}
\end{center}
\end{frame}
